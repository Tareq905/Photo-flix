...
struct EditorView: View {
    ...
    func export() {
        ...
        // Inside your EditorView or wherever the export function is located:
        ...
        if media.type == .image {
            ...
            MediaProcessor.exportVideo(url: media.videoUrl!, layer: sketchLayer, onSuccess: { url in
                print("Temporary Video URL: \(url)")
                close()
            }, onError: {
                withAnimation { isProcesing = false }
